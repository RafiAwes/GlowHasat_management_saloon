...
import { Sparkles, Mail, Lock, ArrowRight, ChevronDown } from 'lucide-react';
    ...
    <div className="min-h-screen bg-salon-bg flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <GlassContainer className="p-6 sm:p-10 shadow-2xl shadow-salon-espresso/5">
          ...
          <div className="mt-8 pt-8 border-t border-salon-ivory/50 text-center space-y-4">
            <p className="text-sm text-salon-gold">
              Don't have an account? {' '}
              <button className="text-salon-bronze font-bold hover:underline">Request Access</button>
            </p>
            
            <div className="bg-salon-cream/30 p-4 rounded-xl border border-salon-ivory/50">
              <p className="text-[10px] uppercase tracking-widest text-salon-gold font-bold mb-2">Troubleshooting</p>
              <p className="text-[11px] text-salon-espresso leading-relaxed">
                If you encounter a "Server IP not found" error, ensure you are using the roles below to navigate. 
                <span className="block mt-1 font-bold text-salon-bronze">Do not type "owner" or "admin" directly into your browser's address bar.</span>
              </p>
            </div>
          </div>
        </GlassContainer>
